...
第一节 一般规定第十二条本市依法保护自然人对其个人信息享有的人格权益。
...
第一节 一般规定第二十五条本市健全公共数据资源体系，加强公共数据治理，提高公共数据共享效率，扩大公共数据有序开放，构建统一协调的公共数据运营机制，推进公共数据和其他数据融合应用，充分发挥公共数据在推动城市数字化转型和促进经济社会发展中的驱动作用。
...
第一节 一般规定第四十七条市人民政府应当按照国家要求，深化数据要素市场化配置改革，制定促进政策，培育公平、开放、有序、诚信的数据要素市场，建立资产评估、登记结算、交易撮合、争议解决等市场运营体系，促进数据要素依法有序流动。
